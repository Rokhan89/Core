    ...
    extends AbstractXmlProduct
{
    ...
    public void setName( String name )
        throws IllegalArgumentException
    {
        BeanCheckUtils.checkStringNotBlank( name, "empty name for products is not allowed" );
    ...
    public void setProjects( List<IProject> projects )
        throws IllegalArgumentException
    {
        BeanCheckUtils.checkCollectionNotEmpty( projects,
                                                "empty list of projects is not allowed to add" );
    ...
    public void addProject( IProject newProject )
        throws IllegalArgumentException
    {
        BeanCheckUtils.checkObjectNotNull( newProject, "null-object as project is not allowed" );
        ...
        throws IllegalArgumentException
    {
        ...
        BeanCheckUtils.checkObjectNotNull( productOwner,
                                           "null person is not allowed as productowner" );
        ...
        throws IllegalArgumentException
    {
        ...
        BeanCheckUtils.checkObjectNotNull( productBacklog,
                                           "null backlog is not allowed as productbacklog" );
