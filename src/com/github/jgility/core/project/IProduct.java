...
/**
 * Schnittstelle, welche das Produkt im Sinne der agilen Softwareentwicklung repräsentiert. Beinhaltet
...
public interface IProduct {
	 ...
	 */
	public abstract void setProductBacklog(
			IBacklog<IProductRequirement> productBacklog)
			throws IllegalArgumentException;
